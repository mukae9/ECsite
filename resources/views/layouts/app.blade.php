...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm" style="background-color:#0092b3; color:#fefefe;">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/shop') }}" style="color:#fefefe; font-size:2.4em;">
                    Larashop
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto" >
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}" style="color:#fefefe;">{{ __('ログイン') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}" style="color:#fefefe;">{{ __('会員登録') }}</a>
                                </li>
                            @endif
                        @else
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                                    document.getElementById('logout-form').submit();" style="color:#585858;">
                                        {{ __('Logout') }}
                                    </a>
                                    <a class="dropdown-item" href="mycart" style="color:#585858;">
                                    {{ __('カート内を見る') }}
                                    </a>
                            ...
                            <a href="/mycart" style="30px;"><img src="{{ asset('image/cart.png') }}" alt="" class="cart" ></a>
                        @endguest
                    </ul>
                </div>
            </div>
